                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                                            ...
                                            <div className="flex-grow flex flex-col">
                                                ...
                                                <div className="flex items-center gap-4 mt-auto">
                                                    <div className="flex items-center border border-gray-200 rounded-lg">
                                                        <button onClick={() => decreaseQty(item.cartid)} className="px-4 py-2">-</button>
                                                        <span className="px-4 py-2 text-gray-900 font-medium">{item.quantity}</span>
                                                        <button onClick={() => increaseQty(item.cartid)} className="px-4 py-2">+</button>
                                                    </div>
                        ...
                        <div className="lg:w-80">
                            <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-6">
                                ...
                                <button onClick={handleCheckout} className="w-full bg-blue-600 text-white py-4 px-6 rounded-lg font-semibold hover:bg-blue-700 mb-4">
                                    Proceed to Checkout
                                </button>
