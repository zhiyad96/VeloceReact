...
function Productdetails() {
    ...
    return (
        <div className=" pt-25 min-h-screen  py-8  ">
                ...
                <div className=" overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
                        ...
                        <div className="flex flex-col justify-center space-y-6">
                            ...
                            <div>
                                 <button onClick={() => addtowish(product)} className="bg-white btn  top-80 left-140">
                            ...
                            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                                <div className="flex items-center space-x-4 bg-gray-100 rounded-lg p-3">
                                    {/* --------decrease--------- */}
                                    <button onClick={() => decreaseQty(incart.cartid)} className="w-8 h-8 flex items-center justify-center bg-white rounded-full shadow-md hover:bg-gray-50 transition-colors">
                                        <span className="text-lg font-semibold">-</span>
                                    </button>
                                    <span className="text-lg font-semibold" >{incart?.quantity}</span>
                                    {/* ---------increase---------- */}
                                    <button onClick={() => increaseQty(incart.cartid)} className="w-8 h-8 flex items-center justify-center bg-white rounded-full shadow-md hover:bg-gray-50 transition-colors">
                                        <span className="text-lg font-semibold">+</span>
                                    </button>
                                </div>
